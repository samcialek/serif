...
export const sarahPersona: Persona = {
  ...
  daysOfData: 2729,
  devices: ['oura', 'apple-watch', 'cgm', 'food-log', 'menstrual-app', 'bloodwork', 'thermostat', 'weather', 'dexa', 'home-bp'],
  deviceConnections: [
    { deviceId: 'menstrual-app', isActive: true, firstConnected: '2018-11-05', lastRefreshed: '2026-04-25T09:20:00Z' },
    { deviceId: 'oura', isActive: true, firstConnected: '2019-09-14', lastRefreshed: '2026-04-25T08:30:00Z' },
    { deviceId: 'apple-watch', isActive: true, firstConnected: '2020-02-02', lastRefreshed: '2026-04-25T08:45:00Z' },
    { deviceId: 'cgm', isActive: true, firstConnected: '2021-04-05', lastRefreshed: '2026-04-21T21:00:00Z' },
    { deviceId: 'food-log', isActive: true, firstConnected: '2021-06-01', lastRefreshed: '2026-04-25T20:10:00Z' },
    { deviceId: 'bloodwork', isActive: true, firstConnected: '2020-01-17', lastRefreshed: '2026-03-28T13:00:00Z' },
    { deviceId: 'thermostat', isActive: true, firstConnected: '2022-06-10', lastRefreshed: '2026-04-25T08:00:00Z' },
    { deviceId: 'weather', isActive: true, firstConnected: '2018-11-05', lastRefreshed: '2026-04-25T08:00:00Z' },
    { deviceId: 'dexa', isActive: true, firstConnected: '2021-05-12', lastRefreshed: '2026-02-20T15:00:00Z' },
    { deviceId: 'home-bp', isActive: true, firstConnected: '2022-05-02', lastRefreshed: '2026-04-25T07:30:00Z' },
  ],
  hasBloodwork: true,
  labDraws: 18,
  thresholds: {
  ...
  loads: [
    {
      ...
      status: 'low',
      unit: 'mg/dL',
      detail: 'Daily glucose CV down from 24% to 14% across the dense glucose record; meal timing and walking are the cleanest levers',
    },
    {
      id: 'sleep-debt',
      label: 'Sleep Debt',
      ...
      status: 'low',
      unit: 'hrs',
      detail: 'Minimal sleep debt (~1.5 hrs/14d) — consistent 7.5+ hr nights',
    },
    {
      id: 'meal-timing-load',
      label: 'Late Meal Load',
      kind: 'load',
      value: 55,
      trend: 'rising',
      trendPositive: false,
      status: 'moderate',
      unit: 'events',
      detail: '3 meals after 7 PM this week; the modeled next-morning glucose cost is about +10-12 mg/dL',
    },
    {
      id: 'stress-load',
      label: 'Stress Load',
      ...
      status: 'moderate',
      unit: 'score',
      detail: 'Self-reported 5/10; manageable but spikes on weeks with irregular eating schedule',
    },
    {
      id: 'alcohol-load',
      label: 'Alcohol Load',
      ...
      status: 'low',
      unit: 'units',
      detail: 'Down to 2 units/week from 6 — each unit adds +8 mg/dL to next-morning glucose',
    },
    {
      ...
      status: 'low',
      unit: 'score',
      detail: 'Post-meal walking is highly consistent and is the key movement-timing signal for glucose',
    },
    {
      id: 'fasting-glucose',
      ...
      status: 'low',
      unit: 'mg/dL',
      detail: 'Fasting glucose 94 mg/dL, down from 118 — now out of pre-diabetic range',
    },
    {
      id: 'hba1c',
      label: 'HbA1c',
      ...
      status: 'low',
      unit: '%',
      detail: 'HbA1c 5.4%, down from 6.1% — reflecting 3 months of glucose improvement',
    },
    {
      id: 'hscrp',
      label: 'hsCRP',
      ...
      status: 'moderate',
      unit: 'mg/L',
      detail: 'hsCRP 1.8 mg/L — borderline; metabolic inflammation still present',
    },
    {
      id: 'triglycerides',
      label: 'Triglycerides',
      ...
      status: 'moderate',
      unit: 'mg/dL',
      detail: 'Triglycerides 142 mg/dL — down from 198; eating window driving improvement',
    },
    {
      id: 'fasting-insulin',
      ...
      status: 'moderate',
      unit: 'μIU/mL',
      detail: 'Fasting insulin 7.8 μIU/mL — improved from 14.2; HOMA-IR normalizing',
    },
    {
      id: 'liver-alt',
      label: 'ALT (Liver)',
      ...
      status: 'low',
      unit: 'U/L',
      detail: 'ALT 22 U/L — normalized from 38; hepatic fat likely decreasing with metabolic improvement',
    },
    {
      id: 'vitamin-d',
      label: 'Vitamin D',
      ...
      status: 'low',
      unit: 'ng/mL',
      detail: '25(OH)D at 42 ng/mL — optimal range; supplementation + outdoor walks working',
    },
  ],
...
export const sarahInsights: Insight[] = [
  {
    ...
    whyNow: 'Your eating-window adherence has stayed consistent while the dense glucose record keeps tightening the estimate.',
    holdoutPreview: {
      metric: 'fasting_glucose',
      expectedChange: -3,
      unit: 'mg/dL',
    ...
    showWork: 'Across the multi-year glucose record, fasting glucose dropped from the high pre-diabetic range to the mid-90s. The improvement accelerated after consistent 8-hour eating windows, lower alcohol exposure, higher fiber, and post-meal walking.',
  },
  {
  ...
  },
  {
    ...
    showWork: 'Your HRV variance is lower while the baseline is higher, but luteal-phase symptoms and heat still create predictable dips. Lower day-to-day variance combined with higher baseline indicates improved autonomic regulation and recovery capacity.',
  },
  {
  ...
  },
  {
    ...
    showWork: 'Your LDL reduction correlates with increased fiber intake, time-restricted eating, and improved metabolic health. The 26% reduction without medication is exceptional. Adding soluble fiber (oats, beans) could push LDL even lower. Note: the per-gram fiber → LDL effect here is bundled with the eating-window + reduced-alcohol changes that happened concurrently; isolating fiber alone awaits a focused experiment.',
    actionable: true,
    priority: 2,
  },
]
...
function generateSarahMetrics(): DailyMetrics[] {
  ...
  for (let i = 0; i < 90; i++) {
    ...
    const _baseGlucose = 118 - (improvementFactor * 24)

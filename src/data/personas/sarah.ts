  ...
  loads: [
    {
      ...
      status: 'low',
      unit: 'mg/dL',
      detail: 'Daily glucose CV down from 24% to 14% over 90 days — eating window is working',
    },
    {
      id: 'sleep-debt',
      label: 'Sleep Debt',
    ...
    },
    {
      ...
      status: 'moderate',
      unit: 'events',
      detail: '3 meals after 7 PM this week — each late meal adds +12 mg/dL to morning glucose',
    },
    {
      id: 'stress-load',
      label: 'Stress Load',
    ...
    },
    {
      ...
      status: 'low',
      unit: 'score',
      detail: '5x/week Zone 2 walks — highly consistent; key driver of glucose improvement',
    },
    {
      id: 'fasting-glucose',

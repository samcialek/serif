...
export const rajanPersona: Persona = {
  ...
  loads: [
    ...
    },
    {
      ...
      status: 'moderate',
      unit: 'ms',
      detail: 'Weekday HRV 35 ms vs weekend 48 ms — chronic work stress driving autonomic imbalance',
    },
    {
      id: 'cortisol-pattern',
      ...
      status: 'high',
      unit: 'score',
      detail: 'Flattened diurnal cortisol curve — morning peak blunted, evening cortisol elevated',
    },
    {
      id: 'lipid-ratio',
      label: 'ApoB:ApoA1',
      ...
      status: 'moderate',
      unit: 'ratio',
      detail: 'Ratio 0.72 — borderline; sleep improvement may lower ApoB independently',
    },
    {
      id: 'testosterone',
      label: 'Testosterone',
      ...
      status: 'moderate',
      unit: 'ng/dL',
      detail: 'Total T 485 ng/dL — declining 8% over 6 months; sleep debt and cortisol likely contributors',
    },
    {
      id: 'fasting-insulin',
      ...
      status: 'moderate',
      unit: 'μIU/mL',
      detail: 'Fasting insulin 9.2 μIU/mL — early insulin resistance signal, tracks with glucose creep',
    },
    {
      id: 'vitamin-d',
      label: 'Vitamin D',
      ...
      status: 'moderate',
      unit: 'ng/mL',
      detail: '25(OH)D at 28 ng/mL — suboptimal; office-bound lifestyle limiting sun exposure',
    },
  ],

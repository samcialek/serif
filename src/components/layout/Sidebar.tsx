...
const navItems: NavItem[] = [
  ...
  { to: '/clients', icon: Building2, label: 'Clients' },
  {
    ...
    children: [
      ...
      { to: '/twin', icon: GitBranch, label: 'Twin', exact: true },
      { to: '/twin-direct', icon: Sliders, label: 'Twin · Direct' },
      { to: '/twin-dragdrop', icon: Hand, label: 'Twin · Drag-drop' },
      { to: '/twin-graph', icon: Share2, label: 'Twin · Graph' },
      { to: '/twin-live', icon: Zap, label: 'Twin · Live' },
      { to: '/twin-cascade', icon: Play, label: 'Twin · Cascade' },
